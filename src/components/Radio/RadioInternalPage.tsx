    ...
    >
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[10px] font-extrabold uppercase tracking-[0.15em] opacity-80">No Grafir</span>
            </div>
            <p className="text-4xl font-black tracking-tight">{noGrafirCount}</p>
            <p className="text-xs opacity-70 mt-1.5 font-medium">tanpa nomor grafir</p>
          </div>
        </motion.div>
      </motion.div>
      ...
      <div className="md:hidden flex flex-col gap-3 bg-[#fbf8ff] p-4 rounded-xl mb-4 border border-purple-100">
        <div className="relative">
          ...
          <Input placeholder="Cari nomor aset, SN, ID radio..." value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }} className="pl-10 pr-4 py-2.5 h-10 border-none rounded-xl focus:ring-2 focus:ring-purple-500 text-sm bg-[#f3e8ff] text-gray-900 placeholder-[#c084fc]" />
        </div>
          ...
          <tbody>
            {loading ? (
              ...
              filteredData.map((item) => {
                ...
                const rowBg = item.isDuplicateId ? "bg-red-50 hover:bg-red-100" : isNoGrafir(item.nomorAset) ? "bg-orange-50 hover:bg-orange-100" : "hover:bg-gray-50";
                return (
      ...
      <div id="mobile-dropdown-divisi" className="hidden fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4 sm:p-0 bg-black/40 backdrop-blur-sm transition-opacity" onClick={() => document.getElementById("mobile-dropdown-divisi")?.classList.add("hidden")}>
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md overflow-hidden flex flex-col max-h-[70vh] animate-in slide-in-from-bottom-8 duration-200" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="overflow-y-auto p-2 space-y-1">
            <div className={`px-4 py-3.5 text-sm rounded-xl cursor-pointer flex justify-between items-center ${!filterDivisi ? 'font-bold text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => { setFilterDivisi(""); setPage(1); document.getElementById("mobile-dropdown-divisi")?.classList.add("hidden"); }}>
              Semua Divisi {!filterDivisi && <Check className="w-4 h-4" />}
            </div>
            {divisiOptions.map((opt) => (
              <div key={opt} className={`px-4 py-3.5 text-sm rounded-xl cursor-pointer flex justify-between items-center ${filterDivisi === opt ? 'font-bold text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => { setFilterDivisi(opt); setPage(1); document.getElementById("mobile-dropdown-divisi")?.classList.add("hidden"); }}>
      ...
      <div id="mobile-dropdown-dept" className="hidden fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4 sm:p-0 bg-black/40 backdrop-blur-sm transition-opacity" onClick={() => document.getElementById("mobile-dropdown-dept")?.classList.add("hidden")}>
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md overflow-hidden flex flex-col max-h-[70vh] animate-in slide-in-from-bottom-8 duration-200" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="overflow-y-auto p-2 space-y-1">
            <div className={`px-4 py-3.5 text-sm rounded-xl cursor-pointer flex justify-between items-center ${!filterDepartment ? 'font-bold text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => { setFilterDepartment(""); setPage(1); document.getElementById("mobile-dropdown-dept")?.classList.add("hidden"); }}>
              Semua Dept {!filterDepartment && <Check className="w-4 h-4" />}
            </div>
            {departmentOptions.map((opt) => (
              <div key={opt} className={`px-4 py-3.5 text-sm rounded-xl cursor-pointer flex justify-between items-center ${filterDepartment === opt ? 'font-bold text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => { setFilterDepartment(opt); setPage(1); document.getElementById("mobile-dropdown-dept")?.classList.add("hidden"); }}>
      ...
      <div id="mobile-dropdown-type" className="hidden fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4 sm:p-0 bg-black/40 backdrop-blur-sm transition-opacity" onClick={() => document.getElementById("mobile-dropdown-type")?.classList.add("hidden")}>
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md overflow-hidden flex flex-col max-h-[70vh] animate-in slide-in-from-bottom-8 duration-200" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="overflow-y-auto p-2 space-y-1">
            <div className={`px-4 py-3.5 text-sm rounded-xl cursor-pointer flex justify-between items-center ${!filterType ? 'font-bold text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => { setFilterType(""); setPage(1); document.getElementById("mobile-dropdown-type")?.classList.add("hidden"); }}>
              Semua Type {!filterType && <Check className="w-4 h-4" />}
            </div>
            {typeOptions.map((opt) => (
              <div key={opt} className={`px-4 py-3.5 text-sm rounded-xl cursor-pointer flex justify-between items-center ${filterType === opt ? 'font-bold text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => { setFilterType(opt); setPage(1); document.getElementById("mobile-dropdown-type")?.classList.add("hidden"); }}>
      ...
      <div id="mobile-dropdown-jenis" className="hidden fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4 sm:p-0 bg-black/40 backdrop-blur-sm transition-opacity" onClick={() => document.getElementById("mobile-dropdown-jenis")?.classList.add("hidden")}>
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md overflow-hidden flex flex-col max-h-[70vh] animate-in slide-in-from-bottom-8 duration-200" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="overflow-y-auto p-2 space-y-1">
            <div className={`px-4 py-3.5 text-sm rounded-xl cursor-pointer flex justify-between items-center ${!filterJenis ? 'font-bold text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => { setFilterJenis(""); setPage(1); document.getElementById("mobile-dropdown-jenis")?.classList.add("hidden"); }}>
              Semua Jenis {!filterJenis && <Check className="w-4 h-4" />}
            </div>
            {["Trunking", "Konvensional"].map((opt) => (
              <div key={opt} className={`px-4 py-3.5 text-sm rounded-xl cursor-pointer flex justify-between items-center ${filterJenis === opt ? 'font-bold text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => { setFilterJenis(opt); setPage(1); document.getElementById("mobile-dropdown-jenis")?.classList.add("hidden"); }}>
